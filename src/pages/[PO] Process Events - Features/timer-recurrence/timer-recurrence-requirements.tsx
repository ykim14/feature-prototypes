  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 space-y-6 text-base text-gray-800 leading-relaxed">
          <div>
      ...
      <div>
        ...
        <div className="space-y-6">
          {[
            ...
            <div key={img.label} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <p className="text-sm font-semibold text-gray-700 mb-3">{img.label}</p>
              <img
                src={img.src}
